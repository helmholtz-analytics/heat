...
def skip_util_params(app, what, name, obj, skip, options):
    """
    Undocumented Global Objects will not be rendered for the documentation
    """
    if what == "data" and obj.is_undoc_member:
        skip = True
    return skip


def skip_util_functions(app, what, name, obj, skip, options):
    """
    Init and doc functions will not be rendered for the documentation
    """
    if "__init__" in name:
        skip = True
    elif "__doc__" in name and obj.is_undoc_member:
        skip = True
    return skip
