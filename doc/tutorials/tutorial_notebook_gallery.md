...
<div class="hg-grid">
  <article class="hg-card">
    <a class="hg-link" href="/tutorials/notebooks/1_basics/">
      <img class="hg-icon" src="/images/logo_emblem.png" alt="Heat basics" />
  ...
  <article class="hg-card">
    <a class="hg-link" href="/tutorials/notebooks/3_loading_preprocessing/">
      <img class="hg-icon" src="/images/jupyter.png" alt="Loading and Preprocessing" />
  ...
  <article class="hg-card">
    <a class="hg-link" href="/tutorials/notebooks/5_clustering/">
      <img class="hg-icon" src="/images/clustering.png" alt="Clustering" />
  ...
  <article class="hg-card">
    <a class="hg-link" href="/tutorials/notebooks/6_profiling/">
      <img class="hg-icon" src="/images/perun_logo.svg" alt="Profiling" />
