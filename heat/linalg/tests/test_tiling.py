    ...
    if ht.MPI_WORLD.size > 1:
        ...
        def test_init_raises(self):
            ...
            with self.assertRaises(TypeError):
                ht.linalg.tiling.SquareDiagTiles("sdkd", tiles_per_proc=1)
            with self.assertRaises(TypeError):
                ht.linalg.tiling.SquareDiagTiles(ht.arange(2), tiles_per_proc="sdf")
            with self.assertRaises(ValueError):
                ht.linalg.tiling.SquareDiagTiles(ht.arange(2), tiles_per_proc=0)
            with self.assertRaises(ValueError):
                ht.linalg.tiling.SquareDiagTiles(ht.arange(2), tiles_per_proc=1)
        ...
        def test_properties(self):
            ...
            m_eq_n_s0_t2 = ht.linalg.tiling.SquareDiagTiles(m_eq_n_s0, tiles_per_proc=2)
            # arr
            ...
            m_eq_n_s1_t1 = ht.linalg.tiling.SquareDiagTiles(m_eq_n_s1, tiles_per_proc=1)
            m_eq_n_s1_t2 = ht.linalg.tiling.SquareDiagTiles(m_eq_n_s1, tiles_per_proc=2)
            # lshape_map
            ...
            m_gr_n_s0_t1 = ht.linalg.tiling.SquareDiagTiles(m_gr_n_s0, tiles_per_proc=1)
            m_gr_n_s0_t2 = ht.linalg.tiling.SquareDiagTiles(m_gr_n_s0, tiles_per_proc=2)
            if m_eq_n_s1.comm.size == 3:
                # col_inds
            ...
            m_gr_n_s1_t1 = ht.linalg.tiling.SquareDiagTiles(m_gr_n_s1, tiles_per_proc=1)
            m_gr_n_s1_t2 = ht.linalg.tiling.SquareDiagTiles(m_gr_n_s1, tiles_per_proc=2)
            if m_eq_n_s1.comm.size == 3:
                # col_inds
            ...
            m_ls_n_s0_t1 = ht.linalg.tiling.SquareDiagTiles(m_ls_n_s0, tiles_per_proc=1)
            m_ls_n_s0_t2 = ht.linalg.tiling.SquareDiagTiles(m_ls_n_s0, tiles_per_proc=2)
            if m_eq_n_s1.comm.size == 3:
                # col_inds
            ...
            m_ls_n_s1_t1 = ht.linalg.tiling.SquareDiagTiles(m_ls_n_s1, tiles_per_proc=1)
            m_ls_n_s1_t2 = ht.linalg.tiling.SquareDiagTiles(m_ls_n_s1, tiles_per_proc=2)
            if m_eq_n_s1.comm.size == 3:
                # col_inds
