...
try:
    ...
    warnings.warn(
        "Heat uses MPI-communication for parallel computation, but an implementation of MPI could not be detected. It will now run in an experimental nonparallel mode with a limited feature set.",
        UserWarning,
    )
