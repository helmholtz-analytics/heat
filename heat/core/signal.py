...
def convolve2d(a, v, mode="full", boundary="fill", fillvalue=0):
    ...
    # Missing: Batch Convolution checks
    ...
    # Missing: switch to arbitrary split dimension!
    ...
    # Missing: Generalize, so stride can be easier added
    if mode == "full":
        pad_0 = v.shape[1] - 1
