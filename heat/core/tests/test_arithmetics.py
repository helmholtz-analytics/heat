...
class TestArithmetics(TestCase):
    ...
    def test_nan_to_num(self):
        ...
        self.assertEqual(result_1_split.split, 0)
        ...
        self.assertEqual(result_2_split.split, 0)
        ...
        self.assertEqual(result_3_split.split, 0)
        ...
        self.assertEqual(result_4_split.split, 0)
