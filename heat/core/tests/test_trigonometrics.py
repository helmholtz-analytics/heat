...
class TestTrigonometrics(BasicTest):
    ...
    def test_rad2deg(self):
        ...
        comparison = (
            180.0
            * torch.tensor(elements, dtype=torch.float64, device=self.torch_device)
            / 3.141592653589793
        )

        # rad2deg with float32
        float32_tensor = ht.array(elements, dtype=ht.float32, device=self.ht_device)
        ...
        float64_tensor = ht.array(elements, dtype=ht.float64, device=self.ht_device)
    ...
    def test_arctan(self):
        # base elements
        elements = 30
        comparison = torch.arange(elements, dtype=torch.float64, device=self.torch_device).atan()
    ...
    def test_arcsin(self):
        ...
        comparison = torch.tensor(elements, dtype=torch.float64, device=self.torch_device).asin()
        ...
        nan_tensor = ht.array([1.2], device=self.ht_device)
    ...
    def test_arccos(self):
        # base elements
        elements = [-1.0, -0.83, -0.12, 0.0, 0.24, 0.67, 1.0]
        comparison = torch.tensor(elements, dtype=torch.float64, device=self.torch_device).acos()
    ...
    def test_cos(self):
        # base elements
        elements = 30
        comparison = torch.arange(elements, dtype=torch.float64, device=self.torch_device).cos()
    ...
    def test_cosh(self):
        # base elements
        elements = 30
        comparison = torch.arange(elements, dtype=torch.float64, device=self.torch_device).cosh()
    ...
    def test_sin(self):
        # base elements
        elements = 30
        comparison = torch.arange(elements, dtype=torch.float64, device=self.torch_device).sin()
    ...
    def test_sinh(self):
        # base elements
        elements = 30
        comparison = torch.arange(elements, dtype=torch.float64, device=self.torch_device).sinh()
    ...
    def test_tan(self):
        # base elements
        elements = 30
        comparison = torch.arange(elements, dtype=torch.float64, device=self.torch_device).tan()
    ...
    def test_tanh(self):
        # base elements
        elements = 30
        comparison = torch.arange(elements, dtype=torch.float64, device=self.torch_device).tanh()
