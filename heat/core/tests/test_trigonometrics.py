...
class TestTrigonometrics(unittest.TestCase):
    def test_rad2deg(self):
        ...
        comparison = (
            180.0 * torch.tensor(elements, dtype=torch.float64) / 3.141592653589793
        )
        ...
        self.assertTrue(
            torch.allclose(float32_rad2deg._DNDarray__array.double(), comparison)
        )
        ...
        self.assertTrue(
            torch.allclose(float64_rad2deg._DNDarray__array.double(), comparison)
        )
    ...
    def test_degrees(self):
        ...
        self.assertTrue(
            torch.allclose(float32_degrees._DNDarray__array.double(), comparison)
        )
        ...
        self.assertTrue(
            torch.allclose(float64_degrees._DNDarray__array.double(), comparison)
        )
    ...
    def test_deg2rad(self):
        ...
        comparison = (
            3.141592653589793 * torch.tensor(elements, dtype=torch.float64) / 180.0
        )
        ...
        self.assertTrue(
            torch.allclose(float32_deg2rad._DNDarray__array.double(), comparison)
        )
        ...
        self.assertTrue(
            torch.allclose(float64_deg2rad._DNDarray__array.double(), comparison)
        )
    ...
    def test_radians(self):
        ...
        self.assertTrue(
            torch.allclose(float32_radians._DNDarray__array.double(), comparison)
        )
        ...
        self.assertTrue(
            torch.allclose(float64_radians._DNDarray__array.double(), comparison)
        )
    ...
    def test_arctan(self):
        ...
        self.assertTrue(
            torch.allclose(float32_arctan._DNDarray__array.double(), comparison)
        )
        ...
        self.assertTrue(
            torch.allclose(float64_arctan._DNDarray__array.double(), comparison)
        )
    ...
    def test_arcsin(self):
        ...
        self.assertTrue(
            torch.allclose(float32_arcsin._DNDarray__array.double(), comparison)
        )
        ...
        self.assertTrue(
            torch.allclose(float64_arcsin._DNDarray__array.double(), comparison)
        )
    ...
    def test_arccos(self):
        ...
        self.assertTrue(
            torch.allclose(float32_arccos._DNDarray__array.double(), comparison)
        )
        ...
        self.assertTrue(
            torch.allclose(float64_arccos._DNDarray__array.double(), comparison)
        )
    ...
    def test_cos(self):
        ...
        self.assertTrue(
            torch.allclose(float32_cos._DNDarray__array.double(), comparison)
        )
        ...
        self.assertTrue(
            torch.allclose(float64_cos._DNDarray__array.double(), comparison)
        )
    ...
    def test_cosh(self):
        ...
        self.assertTrue(
            torch.allclose(float32_cosh._DNDarray__array.double(), comparison)
        )
        ...
        self.assertTrue(
            torch.allclose(float64_cosh._DNDarray__array.double(), comparison)
        )
        ...
        self.assertTrue(
            torch.allclose(int64_cosh._DNDarray__array.double(), comparison)
        )
    ...
    def test_sin(self):
        ...
        self.assertTrue(
            torch.allclose(float32_sin._DNDarray__array.double(), comparison)
        )
        ...
        self.assertTrue(
            torch.allclose(float64_sin._DNDarray__array.double(), comparison)
        )
    ...
    def test_sinh(self):
        ...
        self.assertTrue(
            torch.allclose(float32_sinh._DNDarray__array.double(), comparison)
        )
        ...
        self.assertTrue(
            torch.allclose(float64_sinh._DNDarray__array.double(), comparison)
        )
        ...
        self.assertTrue(
            torch.allclose(int32_sinh._DNDarray__array.double(), comparison)
        )
        ...
        self.assertTrue(
            torch.allclose(int64_sinh._DNDarray__array.double(), comparison)
        )
    ...
    def test_tan(self):
        ...
        self.assertTrue(
            torch.allclose(float32_tan._DNDarray__array.double(), comparison)
        )
        ...
        self.assertTrue(
            torch.allclose(float64_tan._DNDarray__array.double(), comparison)
        )
    ...
    def test_tanh(self):
        ...
        self.assertTrue(
            torch.allclose(float32_tanh._DNDarray__array.double(), comparison)
        )
        ...
        self.assertTrue(
            torch.allclose(float64_tanh._DNDarray__array.double(), comparison)
        )
        ...
        self.assertTrue(
            torch.allclose(int32_tanh._DNDarray__array.double(), comparison)
        )
        ...
        self.assertTrue(
            torch.allclose(int64_tanh._DNDarray__array.double(), comparison)
        )
