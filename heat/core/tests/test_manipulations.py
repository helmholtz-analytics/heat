...
class TestManipulations(TestCase):
    def test_argsort(self):
        ...
        result1 = ht.argsort(data, axis=1, descending=True)
        result2 = ht.argsort(data, descending=True)
        self.assertTrue(ht.equal(result1, result2))
        ...
        #
        indices = ht.argsort(data, axis=2)
