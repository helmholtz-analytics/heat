...
class TestManipulations(TestCase):
    ...
    def test_topk(self):
        ...
        exp_zero_indcs = ht.array([[size - 1, size - 2] for i in range(size)], dtype=ht.int64, split=0)
        ...
        exp_one_indcs = ht.array([[size - 1, size - 2] for i in range(size)], dtype=ht.int64, split=1)
