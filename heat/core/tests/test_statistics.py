...
class TestStatistics(TestCase):
    def test_argmax(self):
        ...
        self.assertEqual(result.V_local_larray.dtype, torch.int64)
        self.assertEqual(result.shape, (4, 5))
        self.assertEqual(result.lshape, (4, 5))
        self.assertEqual(result.split, None)
        self.assertTrue((result.V_local_larray == data.V_local_larray.argmax(0)).all())
        ...
        self.assertEqual(result.split, None)
        self.assertTrue(
            (result.V_local_larray == data.V_local_larray.argmax(-1, keepdims=True)).all()
        )
        ...
        self.assertEqual(output.V_local_larray.dtype, torch.int64)
        self.assertEqual(output.shape, (size,))
        self.assertEqual(output.lshape, (size,))
        self.assertEqual(output.split, None)
        # skip test on gpu; argmax works different
        if not (torch.cuda.is_available() and result.device == ht.gpu):
            self.assertTrue((output.V_local_larray == expected).all())
    ...
    def test_argmin(self):
        ...
        self.assertEqual(result.lshape, (1,))
        self.assertEqual(result.split, None)
        self.assertTrue((result.V_local_larray == data.V_local_larray.argmin()).all())
        ...
        self.assertEqual(result.lshape, (4, 5))
        self.assertEqual(result.split, None)
        self.assertTrue((result.V_local_larray == data.V_local_larray.argmin(0)).all())
        ...
        self.assertEqual(result.split, None)
        self.assertTrue(
            (result.V_local_larray == data.V_local_larray.argmin(-1, keepdim=True)).all()
        )

        # 2D split tensor, along the axis
        data = ht.array(ht.random.randn(4, 5), is_split=0)
        result = ht.argmin(data, axis=1)
        expected = torch.argmin(data.V_local_larray, dim=1)
        self.assertIsInstance(result, ht.DNDarray)
        self.assertEqual(result.dtype, ht.int64)
        self.assertEqual(result.V_local_larray.dtype, torch.int64)
        self.assertEqual(result.shape, (ht.MPI_WORLD.size * 4,))
    ...
    def test_average(self):
        ...
        self.assertEqual(avg.V_local_larray.dtype, torch.float32)
        ...
        self.assertEqual(avg_vertical.V_local_larray.dtype, torch.float32)
        ...
        self.assertEqual(avg_horizontal.V_local_larray.dtype, torch.float32)
        ...
        self.assertEqual(avg_volume.V_local_larray.dtype, torch.float64)
        ...
        self.assertEqual(avg_volume.V_local_larray.dtype, torch.float32)
    ...
    def test_histc(self):
        ...
        self.assertTrue(torch.equal(res.V_local_larray, comp))
        ...
        self.assertEqual(res.device, self.device)
        self.assertEqual(res.split, None)
        self.assertTrue(torch.equal(out.V_local_larray, comp))
    ...
    def test_max(self):
        ...
        self.assertEqual(maximum.V_local_larray.dtype, torch.int64)
        ...
        self.assertEqual(maximum_vertical.V_local_larray.dtype, torch.int64)
        self.assertTrue(
            (maximum_vertical.V_local_larray == comparison.max(dim=0, keepdim=True)[0]).all()
        )
        ...
        self.assertEqual(maximum_horizontal.V_local_larray.dtype, torch.int64)
        self.assertTrue(
            (maximum_horizontal.V_local_larray == comparison.max(dim=1, keepdim=True)[0]).all()
        )
        ...
        self.assertEqual(maximum_volume.V_local_larray.dtype, torch.float32)
        ...
        self.assertEqual(maximum_5d.V_local_larray.dtype, torch.float32)
        ...
        if size > 1:
            ...
            self.assertTrue(torch.equal(res.V_local_larray, expected))
    ...
    def test_maximum(self):
        ...
        self.assertEqual(maximum.dtype, ht.int64)
        self.assertEqual(maximum.V_local_larray.dtype, torch.int64)
        self.assertTrue((maximum.V_local_larray == torch.max(comparison1, comparison2)).all())
        ...
        self.assertEqual(output.V_local_larray.dtype, torch.float32)
    ...
    def test_min(self):
        ...
        self.assertEqual(minimum.V_local_larray.dtype, torch.int64)
        ...
        self.assertEqual(minimum_vertical.V_local_larray.dtype, torch.int8)
        self.assertTrue(
            (minimum_vertical.V_local_larray == comparison.min(dim=0, keepdim=True)[0]).all()
        )
        ...
        self.assertEqual(minimum_horizontal.V_local_larray.dtype, torch.int16)
        self.assertTrue(
            (minimum_horizontal.V_local_larray == comparison.min(dim=1, keepdim=True)[0]).all()
        )
        ...
        self.assertEqual(minimum_volume.V_local_larray.dtype, torch.float32)
        ...
        self.assertEqual(minimum_5d.V_local_larray.dtype, torch.float32)
    ...
    def test_minimum(self):
        ...
        self.assertEqual(minimum.dtype, ht.int64)
        self.assertEqual(minimum.V_local_larray.dtype, torch.int64)
        self.assertTrue((minimum.V_local_larray == torch.min(comparison1, comparison2)).all())
