...
class TestOperations(unittest.TestCase):
    ...
    def test_argmin(self):
        ...
        self.assertEqual(random_data_split.argmin(axis=1).shape, (random_data_split.lshape[random_data_split.split],1,3))
        ...
        self.assertEqual(random_data_split_neg.argmin(axis=-2).shape, (1,random_data_split_neg.lshape[random_data_split_neg.split],3,1,5))
