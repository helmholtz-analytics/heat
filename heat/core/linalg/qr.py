...
def qr(
    ...
    if a.split is None:
        ...
        q = DNDarray(
            q, gshape=a.lshape, dtype=a.dtype, split=0, device=a.device, comm=a.comm, balanced=False
        )
        r = DNDarray(
            r, gshape=a.lshape, dtype=a.dtype, split=0, device=a.device, comm=a.comm, balanced=True
        )
