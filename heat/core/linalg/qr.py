...
def __split0_local_q_calc(a_tiles, q0_tiles, col, q_dict, diag_process, active_procs):
    """
...
def __split0_r_calc(a_tiles, q_dict, q_dict_waits, col_num, diag_pr, not_completed_prs):
    """
