...
def parse():
    ...
    parser.add_argument(
        "--train",
        metavar="DIR",
        default="/hkfs/work/workspace/scratch/qv2382-heat/imagenet-data/imagenet-processed/train/",
        nargs="*",
    ...
    parser.add_argument(
        "--validate",
        metavar="DIR",
        default="/hkfs/work/workspace/scratch/qv2382-heat/imagenet-data/imagenet-processed/val/",
        nargs="*",
    ...
    parser.add_argument(
        "--train_indexes",
        metavar="DIR",
        default="/hkfs/work/workspace/scratch/qv2382-heat/imagenet-data/imagenet-processed/train-idx/",
        nargs="*",
    ...
    parser.add_argument(
        "--validate_indexes",
        metavar="DIR",
        default="/hkfs/work/workspace/scratch/qv2382-heat/imagenet-data/imagenet-processed/val-idx/",
        nargs="*",
...
#
#         self.input = dali.fn.readers.tfrecord(
#             path=data_dir_list,
...
#             )
#         else:
#             self.decode = fn.decoders.image(device="cpu", output_type=dali.types.RGB)
#             self.resize = fn.Resize(
...
def main():
    ...
    if torch.cuda.device_count() > 1:
        ...
        port = str(29500 + (rank // torch.cuda.device_count()))
        # print(port, args.world_size, args.gpus)
