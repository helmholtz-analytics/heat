...
def test_split():
    ...
    t_sparse = ht.sparse_csr_matrix(t, split=0)
...
def test_conversion():
    ...
    assert (ht.sparse_csr_matrix(t).data == ht.sparse_csr_matrix(s).data).all()
    assert (ht.sparse_csr_matrix(t).indptr == ht.sparse_csr_matrix(s).indptr).all()
    assert (ht.sparse_csr_matrix(t).indices == ht.sparse_csr_matrix(s).indices).all()
...
def test_is_split():
    ...
    t_sparse = ht.sparse_csr_matrix(t, is_split=0)

    assert isinstance(t_sparse, ht.core.Dcsr_matrix.Dcsr_matrix)
