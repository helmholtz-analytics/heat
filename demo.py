...
X = ht.load_hdf5('diabetes.h5', dataset='x', split=0)
y = ht.load_hdf5('diabetes.h5', dataset='y', split=0)
...
# plot lasso paths
plotfkt.plot_lasso_path(lamda, theta_lasso,diabetes.feature_names, title='Lasso Paths - HeAT implementation')
...
# plot lasso paths
plotfkt.plot_lasso_path(lamda, theta_lasso,diabetes.feature_names, title='Lasso Paths - Numpy implementation')
...
# plot lasso paths
plotfkt.plot_lasso_path(lamda, theta_lasso,diabetes.feature_names, title='Lasso Paths - PyTorch implementation')
