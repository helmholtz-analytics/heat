...
export HEAT_BENCHMARK_NUM_NODES=2
...
do
	...
	export HEAT_BENCHMARK_NUM_MPI_PROCS=$(($HEAT_BENCHMARK_NUM_NODES*$HEAT_BENCHMARK_NUM_CPUS_PER_NODE/$HEAT_BENCHMARK_NUM_THREADS_PER_MPI_PROC))
