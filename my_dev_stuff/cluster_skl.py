...
for n_clusters in range(2, n_cluster_max + 1):
    ...
    for s in range(n_samples):
        ...
        values_sklkm.append(functional_value(data, clusterer_sklkm.cluster_centers_, clusterer_sklkm.labels_))
        del clusterer_sklkm
        ...
        values_sklbkm.append(functional_value(data, clusterer_sklbkm.cluster_centers_, clusterer_sklbkm.labels_))
