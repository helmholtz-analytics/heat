...
## Changes ### Documentation - #1406 New tutorials for interactive parallel mode for both HPC and local usage (by @ClaudiaComito) ### 🔥 Features - #1288 Batch-parallel K-means and K-medians (by @mrfh92) - #1228 Introduce in-place-operators for `arithmetics.py` (by @LScheib) - #1218 Distributed Fast Fourier Transforms (by @ClaudiaComito) ### Bug fixes - #1363 `ht.array` constructor respects implicit torch device when copy is set to false (by @JuanPedroGHM) - #1216 Avoid unnecessary gathering of distributed operand (by @samadpls) - #1329 Refactoring of QR: stabilized Gram-Schmidt for split=1 and TS-QR for split=0 (by @mrfh92) ### Interoperability - #1418 and #1290: Support PyTorch 2.2.2 (by @mtar) - #1315 and #1337: Fix some NumPy deprecations in the core and statistics tests (by @FOsterfeld) ## Contributors @ClaudiaComito, @FOsterfeld, @JuanPedroGHM, @LScheib, @mrfh92, @mtar, @samadpls
